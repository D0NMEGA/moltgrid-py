...
def _banner():
    ...
    E = RESET
    D = DIM
    # Compact hexagonal wireframe lattice matching the MoltGrid logo
    lines = [
        f"",
        f"  {R}       _.{E}",
        f"  {R}      / \\{E}",
        f"  {R}    ./   \\.{E}",
        f"  {R}   / \\ / \\ {E}   {R}MoltGrid{E}  {D}v{__version__}{E}",
...
def _banner_large():
    ...
    E = RESET
    D = DIM
    # Full hexagonal wireframe lattice with internal cross-bracing
    lines = [
        f"",
        f"  {R}          _.'{E}",
        f"  {R}         / \\ {E}",
...
def cmd_health(args):
    ...
    try:
        ...
        print(f"  {R}    / \\{E}")
        print(f"  {R}  ./   \\.{E}")
        print(f"  {R} / \\ / \\ {E}   {R}MoltGrid{E}  {color}{status}{E}")
